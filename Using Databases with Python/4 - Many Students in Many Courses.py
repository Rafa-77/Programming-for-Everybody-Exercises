...
# Once you have made the necessary changes to the program and it has been run successfully reading the above
...
fname = r"D:\alex_\Documents\Programacion\Cursos\Python for Everybody\4 - Using Databases with Python\Files\roster_data.json"
