...
# Preferred:
# 1- Modify the socket1.py program to retrieve the above URL and print out the headers and data.
#    Make sure to change the code to retrieve the above URL - the values are different for each URL.
# 2- Open the URL in a web browser with a developer console or FireBug and manually examine the
